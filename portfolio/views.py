...
def index(request):
    ...
    ui_queryset = ['HTML5/CSS3 ', 'Bootstrap 3+', 'Custom and 3rd party font-faces and iconic fonts e.g FontAwesome', 'Responsive CSS Sprites', 'Ajax and Animation via Javascript/jQuery', '2-Way data binding and loose coupling with AngularJS']
