...
(function( $ ){
    ...
    var aboutElem = document.getElementsByClassName("about_section");

    $( document ).on('scroll', function( event ){
        if ( isScrolledIntoView( aboutElem ) == true) {
            console.log("You're over about!");

            var $aboutElem = $( aboutElem );

            $aboutElem.stop().animate({
                marginLeft: "+=1000",
                opacity: 1
            },{
                queue:true,
